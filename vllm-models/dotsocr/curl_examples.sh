...
# =============================================================================
# Ejemplos de curl para validar el modelo DotsOCR
# =============================================================================
# Archivo: curl_examples.sh
# Uso: ./curl_examples.sh [PORT]
#
# Ejemplos para probar diferentes funcionalidades del modelo DotsOCR
# con RTX 4090 optimizada

VLLM_PORT=${1:-8002}
BASE_URL="http://localhost:$VLLM_PORT"

echo "🚀 Ejecutando ejemplos de curl para DotsOCR en $BASE_URL"
echo "================================================================="
...
run_curl_example "3. Información del Modelo DotsOCR" "
curl -s \"$BASE_URL/v1/models/dotsocr\" \
  | jq . 2>/dev/null
"
...
echo "   - Usa 'docker-compose logs vllm-dotsocr' para ver logs detallados"
echo "   - Asegúrate de que el puerto $VLLM_PORT esté disponible"
echo ""
echo "🚀 Para ejecutar ejemplos individuales:"
echo "   curl -X POST \"$BASE_URL/v1/completions\" -H 'Content-Type: application/json' -d '{\"model\":\"dotsocr\",\"prompt\":\"Hello world\",\"max_tokens\":10}'"